...
export class ValueSelector extends React.Component<ValueSelectorProps, ValueSelectorState>{
...
export class UserInfoPage extends React.Component<Props, { userInfo: UserInfo }>{
    ...
    saveUserInfo() {
        ...
        return this.props.member.saveUserInfo(this.state.userInfo).then(() => {
                        ...
                        <div className="list-group">
                            <div className="list-group-item row">
                                ...
                                <div className="col-xs-9">
                                    ...
                                    <ImageBox ref={(e) => this.imageBox = e || this.imageBox} imageSource={userInfo.HeadImageUrl} imageText="上传头像" imageClassName="img-circle pull-right" />
                                </div>
                            </div>
                            <div className="list-group-item row">
