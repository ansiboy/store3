import { Page, Menu, app, siteMap, PageProps } from 'site';
...
export class IndexPage extends React.Component<IndexPageProps, IndexPageStatus>{
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            address: '',
            activeCategory: null,//this.props.categories[0]
            // products: [],
            // categories: [],
        };
    ...
    scrollTo(categoryName: string) {
        let element = this.props.element.querySelector(`[${this.elementCategoryAttr}=${categoryName}]`) as HTMLElement;
